                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="date" id="fechaantesrecaida_ace" name="fechabaja_ace" class="form-control" tabindex="1">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <label for="agentematerial_ace" class="col-form-label col-sm-2">Desviacion producida:</label>
                                    <div class="col-sm-9">
                                        <select name="agentematerial_ace" id="tipolugar_ace" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <label for="matercausalesi_ace" class="col-form-label col-sm-2">Agente material causa lesion:</label>
                                    <div class="col-sm-9">
                                        <select name="matercausalesi_ace" class="form-control">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group row">
                                    <label for="tipolesion_ace" class="col-form-label col-sm-3">Parte del cuerpo lesionada:</label>
                                    <div class="col-sm-9">
                                        <select name="tipolesion_ace" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="detallescentromedico_ace" class="col-form-label col-sm-3">Centro médico:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="detallescentromedico_ace" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <label for="recomedincorp_ace" class="col-form-label col-sm-4">Fecha recomedico incorporacion:</label>
                                    <div class="col-sm-3">
                                        <input type="date" id="recomedincorp_ace" name="fechabaja_ace" class="form-control" tabindex="1">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group row">
                                    <label for="isinformado_ace" class="col-form-label col-sm-4">Ha recibido informacion (Art. 18 LPRL):</label>
                                    <div class="col-sm-3">
                                        <select class="form-select" name="isinformado_ace" aria-label="Default select example">
                                            <option selected>-</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                            ...
                            <div class="col-sm-3">
                                <div class="form-group row">
                                    <label for="isformado_ace" class="col-form-label col-sm-4">Ha recibido formacion (Art. 19 LPRL):</label>
                                    <div class="col-sm-3">
                                        <select class="form-select" name="isformado_ace" aria-label="Default select example">
                                            <option selected>-</option>
                                            <option value="SI">SI</option>
                                            <option value="NO">NO</option>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="episdisp_ace" class="col-form-label col-sm-3">EPIs necesarios:</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="episdisp_ace" class="form-control" value="">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div class="form-group row">
                                    <label for="medidasprev_ace" class="col-form-label col-sm-3">Medidas preventivas:</label>
                                    <div class="col-sm-9">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="observprotcol_ace" class="col-form-label col-sm-3">Que operaciones realizaba:</label>
                                    <div class="col-sm-8">
                                        <input type="text" name="observprotcol_ace" class="form-control" value="">
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group row">
                                    <label for="histmedidaacc_ace" class="col-form-label col-sm-3">Medidas adoptadas:</label>
                                    <div class="col-sm-8">
