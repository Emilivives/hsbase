...
<!-- /.content- -->
<div class="content">
    <form action="../../app/controllers/accidentes/create_asistencia.php" method="post">
            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <div class="form-group row">
                        <label for="nombre" class="col-form-label col-sm-2" hidden>Nº:</label>
                        <div class="col-sm-1">
                            <input type="text" name="nroaccidente_ace" id="nroaccidente_ace" class="form-control" placeholder="nro. accdidente" tabindex="1" hidden>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-1">
                    <div class="form-group row">
                        <label for="comunicado_ace" class="col-form-label col-sm-4" hidden>Comunicado:</label>
                        <div class="col-sm-1">
                            <select class="form-select" name="comunicado_ace" aria-label="Default select example" hidden>
                ...
                <div class="col-sm-2">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select name="tipoaccidente_ace" id="tipoaccidente_ace" class="form-control" onchange="selectIdta(event)"required>
                ...
                <div class="col-sm-2">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <select name="trabajador_ace" id="trabajador_ace" style="width: 120%" class="trabajador_ace" onchange="selectIdtr(event)"required>
                ...
                <div class="col-sm-2">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <select name="centro_ace" id="btn_centro" class="form-control" onchange="selectIdcen(event)"required>
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-select" name="lugar_ace" aria-label="Default select example"required>
                        ...
                        <div class="col-sm-9">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="detalleslugar_ace" id="" class="form-control"required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="time" name="hora_ace" class="form-control" tabindex="1"required>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-8">
                            <div class="form-group row">
                                <label for="observproceso_ace" class="col-form-label col-sm-2">Tarea que realizaba</label>
                                <div class="col-sm-9">
                                    <input type="text" name="observproceso_ace" class="form-control"required>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control" name="descripcion_ace" rows="3"required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-5">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="tipolesion_ace" class="form-control"required>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-7">
                                    <select name="gradolesion_ace" class="form-control"required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="partecuerpo_ace" class="form-control"required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <select name="formacontacto_ace" class="formacontacto_ace" id="formacontacto_ace" style="width: 100%">
                                        <option value="1">--Seleccione la forma de contacto--</option>
                                        <?php
                                ...
                                <div class="col-sm-9">
                                    <select name="matercasusalesi_ace" class="matercasusalesi_ace" id="matercasusalesi_ace" style="width: 100%">
                                        ...
                                        foreach ($ace_agentematerialles_datos as $ace_agentematerialles_dato) { ?>
                                            <option value="<?php echo $ace_agentematerialles_dato['id_agentematerialles']; ?>"><?php echo $ace_agentematerialles_dato['codagentematles_aml']; ?> | <?php echo $ace_agentematerialles_dato['agentematerialles_aml']; ?> </option>
                                        <?php
                                        }
                                        ?>
                                    </select>
