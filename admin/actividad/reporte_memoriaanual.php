...
class MYPDF extends TCPDF
{
    ...
    public function Header()
    {
        ...
        $this->Cell(0, 15, 'MEMORIA: ' . $this->nombre_py, 0, 1, 'L');
...
$html .= '<table border="1" cellpadding="4" width="100%">
            ...
            <tr>
                <td style="width: 25%;"><b>Nombre del Proyecto:</b></td>
...
$html .= '<thead>
            <tr style="background-color: #003366; color: #FFFFFF; font-size: 10px;"> <!-- Fondo azul marino y texto blanco -->
                ...
                <th style="font-weight: bold; text-align: center; width: 15%;">Estado</th>
                <th style="font-weight: bold; text-align: center; width: 10%;">Fecha</th>
            </tr>
          </thead>';
$html .= '<tbody>';
...
foreach ($tareas as $tarea) {
    ...
    $html .= '<tr>
                ...
                <td style="text-align: center; width: 10%;">' . htmlspecialchars($tarea['nombre_resp']) . '</td>
                <td style="text-align: center; width: 15%;">' . htmlspecialchars($tarea['estado_ta']) . '</td>
                <td style="text-align: center; width: 10%;">' . date('d/m/Y', strtotime($tarea['fechareal_ta'])) . '</td>
              </tr>';

    if (!empty($actividadesPorTarea[$tarea['id_tarea']])) {
        foreach ($actividadesPorTarea[$tarea['id_tarea']] as $actividad) {
            $html .= '<tr>
                                <td colspan="6" style="text-align: left; font-style: italic; font-size: 8px;">
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-  ' . date('d/m/Y', strtotime($actividad['fecha_acc'])) . ' - ' . htmlspecialchars($actividad['detalles_acc']) . '
                                </td>
                              </tr>';
        }
    }
