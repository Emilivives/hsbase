...
<input type="text" class="knob" value="<?php $contador_de_trabajadores?>" data-min="0" data-max="<?php $contador_de_trabajadores?>" 
data-readonly="true" data-thickness="0.1"
data-width="90" data-height="90" data-fgColor="#00a65a" disabled>
