...
<div class="row">
    ...
    <form action="../../app/controllers/formaciones/registrar_formacion.php" method="post">
        <div class="row">
            <div class="col-md-7">
                ...
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fecha_fr" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="">Valido hasta</label>
                                    <input type="date" name="fechacad_fr" class="form-control">
                                </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <?php
                            $nro_formacion = "<script> document.writeln(nroformacion); </script>";
                            ?>
                           <input type="text" value="<?php echo $nro_formacion ?>" name="nro_formacion" id="nro_formacion">
                        </div>
