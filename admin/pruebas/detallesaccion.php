...
<div class="content">
    <div class="row">
        <form action="../../app/controllers/actividad/update_accionprl.php" method="post">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="descripcion_acc" value="<?php echo $descripcion_acc ?>" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="accpropuesta_acc" value="<?php echo $accpropuesta_acc ?>" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea class="form-control" name="accrealizada_acc" value="<?php echo $accrealizada_acc ?>" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-7">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" name="seguimiento_acc" value="<?php echo $seguimiento_acc ?>" rows="4"></textarea>
                                </div>
                            </div>
                        </div>
