                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                    		 <div class="form-group">
								  ...
								  <input type="text" value="<?php echo $reconocimientos_dato['nombre_tr'] ?>" name="" class="form-control" readonly>
                                        <input type="text" value="<?php echo $reconocimientos_dato['trabajador_rm'] ?>" name="trabajador_rm" class="form-control" hidden>
                                    </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="cita_rm" id="flexRadioDefault6" value="0" <?php if ($reconocimientos_dato['cita_rm'] == "0") {
                                                                                                                                        echo 'Checked';
                                                                                                                                    } ?>>
                                    <label class="form-check-label" for="flexRadioDefault3">
                                        <b><?php $reconocimientos_dato['cita_rm'];
