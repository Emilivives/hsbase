...
$tipolugar_ace = !empty($_POST['tipolugar_ace']) ? $_POST['tipolugar_ace'] : 0;
...
$formacontacto_ace = (isset($_POST['formacontacto_ace']) && ctype_digit($_POST['formacontacto_ace']) && $_POST['formacontacto_ace'] != '0') ? $_POST['formacontacto_ace'] : NULL;
...
if ($sentencia->execute()) {
    ...
    $id_accidente = $pdo->lastInsertId();
    
    // Redirige a una página que genera el PDF con el ID del accidente
    header("Location: ../../../admin/maestros/documentos/pdf_solicitudmutua.php?id_accidente=$id_accidente");
