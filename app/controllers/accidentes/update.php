...
$sentencia = $pdo->prepare("UPDATE accidentes set id_accidente=:id_accidente,nroaccidente_ace=:nroaccidente_ace,trabajador_ace=:trabajador_ace,centro_ace=:centro_ace,lugar_ace=:lugar_ace,detalleslugar_ace=:detalleslugar_ace,tipoaccidente_ace=:tipoaccidente_ace,fecha_ace=:fecha_ace,fechabaja_ace=:fechabaja_ace,hora_ace=:hora_ace,horatrabajo_ace=:horatrabajo_ace,trabajohabitual_ace=:trabajohabitual_ace,diadescanso_ace=:diadescanso_ace,semanadescanso_ace=:semanadescanso_ace,isevaluadoriesgo_ace=:isevaluadoriesgo_ace,evalconriesgo_ace=:evalconriesgo_ace,isrecaida_ace=isrecaida_ace:,fechaantesrecaida_ace=:fechaantesrecaida_ace,descripcion_ace=:descripcion_ace,tipolugar_ace=:tipolugar_ace,zonalugar_ace=:zonalugar_ace,observaclugar_ace=:observaclugar_ace,procesotrabajo_ace=:procesotrabajo_ace,observproceso_ace=:observproceso_ace,tipoactividad_ace=:tipoactividad_ace,observtipoactiv_ace=:observtipoactiv_ace,agentematerial_ace=:agentematerial_ace,observagmaterial_ace=:observagmaterial_ace,desviacion_ace=:desviacion_ace,observdesviacion_ace=:observdesviacion_ace,agmaterdesv_ace=:agmaterdesv_ace,observagendesv_ace=:observagendesv_ace,formacontacto_ace=:formacontacto_ace,observformacont_ace=:observformacont_ace,matercasusalesi_ace=:matercasusalesi_ace,observmatlesi_ace=:observmatlesi_ace,numtrafectados_ace=:numtrafectados_ace,declaraciontrab_ace=:declaraciontrab_ace,istestigos_ace=:istestigos_ace,detallestestigo_ace=:detallestestigo_ace,declaraciontestigo_ace=:declaraciontestigo_ace,tipolesion_ace=:tipolesion_ace,gradolesion_ace=:gradolesion_ace,partecuerpo_ace=:partecuerpo_ace,isevacuacion_ace=:isevacuacion_ace,lugarevacuacion_ace=:lugarevacuacion_ace,centromedico_ace=:centromedico_ace,detallescentromed_ace=:detallescentromed_ace,recomedincorp_ace=:recomedincorp_ace,recinedtrab_ace=:recinedtrab_ace,istrformado_ace=istrformado_ace:,istrinformado_ace=:istrinformado_ace,protcolectivadisp_ace=:protcolectivadisp_ace,protcolecnecesa_ace=:protcolecnecesa_ace,observprotcol_ace=:observprotcol_ace,episdispon_ace=:episdispon_ace,episneces_ace=:episneces_ace,observepis_ace=:observepis_ace,causaaccidente_ace=:causaaccidente_ace,porquecausa_ace=:porquecausa_ace,quiencontrolcausa_ace=:quiencontrolcausa_ace,conclusionacci_ace=:conclusionacci_ace,medidasprev_ace=medidasprev_ace:,valoracionmedida_ace=:valoracionmedida_ace,histaccult12mes_ace=:histaccult12mes_ace,histpuestoacc_ace=:histpuestoacc_ace,histtrabajosreal_ace=:histtrabajosreal_ace,histcausaacc_ace=:histcausaacc_ace,histmedidaacc_ace=:histmedidaacc_ace,investigador_ace=:investigador_ace,cargoinvesiga_ace=:cargoinvesiga_ace,fechainvestiga_ace=:fechainvestiga_ace,fechacumplimen_ace=:fechacumplimen_ace,revisadopor_ace=:revisadopor_ace,cargorevisado_ace=:cargorevisado_ace,fecharevision_ace=:fecharevision_ace)
