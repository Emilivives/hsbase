...
$sql = "SELECT acc.id_accion as id_accion, acc.codigo_acc as codigo_acc, acc.fecha_acc as fecha_acc, cen.nombre_cen as nombre_cen, acc.prioridad_acc as prioridad_acc, acc.descripcion_acc as descripcion_acc, resp.nombre_resp as nombre_resp,
