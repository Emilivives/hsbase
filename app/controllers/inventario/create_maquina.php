...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $epis_maq = isset($_POST['epis_maq']) ? $_POST['epis_maq'] : [];  // Array de epis
    $observaciones_maq = $_POST['observaciones_maq'];

    $epis_maq_str = implode(',', $epis_maq); // Convertir el array a una cadena separada por comas
    ...
    try {
        $sentencia = $pdo->prepare("INSERT INTO inv_maquinaria (tipo_maq, marca_maq, modelo_maq, numserie_maq, proveedor_maq, manual_maq, marcace_maq, aniofab_maq, centro_maq, estado_maq, epis_maq, observaciones_maq, img1_maq, img2_maq, imgmto1_maq, imgmto2_maq)
         VALUES (:tipo_maq, :marca_maq, :modelo_maq, :numserie_maq, :proveedor_maq, :manual_maq, :marcace_maq, :aniofab_maq, :centro_maq, :estado_maq, :epis_maq, :observaciones_maq, :img1_maq, :img2_maq, :imgmto1_maq, :imgmto2_maq)");
        ...
        $sentencia->bindParam('epis_maq', $epis_maq_str);
