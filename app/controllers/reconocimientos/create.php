...
$sentencia = $pdo->prepare("INSERT INTO reconocimientos (trabajador_rm, fecha_rm, caducidad_rm, vigente_rm, cita_rm, anotaciones_rm) 
VALUES(:trabajador_rm, :fecha_rm, :caducidad_rm, :vigente_rm, :cita_rm, :anotaciones_rm)");
