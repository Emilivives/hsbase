...
$sentencia = $pdo->prepare("UPDATE citas_rm SET id_citarm=:id_citarm, trabajador_crm=:trabajador_crm, fecha_crm=:fecha_crm, anotaciones_crm=:anotaciones_crm WHERE id_citarm=:id_citarm");
