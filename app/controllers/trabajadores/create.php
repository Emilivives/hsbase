...
$sentencia = $pdo->prepare("INSERT INTO trabajadores (id_trabajador, codigo_tr, dni_tr, nombre_tr, sexo_tr, fechanac_tr, categoria_tr, inicio_tr, centro_tr, activo_tr, fyh_creacion, fyh_actualizacion) 
VALUES(NULL, :codigo_tr, :dni_tr, :nombre_tr, :fechanac_tr, sexo_tr, :categoria_tr, :inicio_tr, :centro_tr, :activo_tr, :fyh_creacion, :fyh_actualizacion)");
