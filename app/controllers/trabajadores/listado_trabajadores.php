...
tr.activo_tr as activo_tr, tr.formacionpdt_tr as formacionpdt_tr, cat.nombre_cat as nombre_cat, cat.departamento_cat as departamento_cat, cen.nombre_cen as nombre_cen , emp.nombre_emp as nombre_emp, tc.nombre_tc as nombre_tc
