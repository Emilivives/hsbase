...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-01-2024 a las 14:06:00
...
(4, 1, 'Programacion anual', '2023-11-09', '2023-11-09', 4, 1, 'alta', 'En curso', 1, 'detalles de la tarea con su descripciones', 'documentos', 1),
...
(3, 'Amarrador', 'detalles de categoria amarrador'),
(21, 'Informático', 'Detalles puesto informatico');
...
INSERT INTO `empresa` (`id_empresa`, `nombre_emp`, `razonsocial_emp`, `cif_emp`, `direccion_emp`) VALUES
(1, 'TRASMAPI', 'SERVICIOS Y CONCESIONES MARITIMAS IBICENCAS S.A.', 'A07066749', 'C/ Aragón, 71. 07800. Eivissa (Illes Balears)'),
(2, 'FORMENTERA LINES', 'MEDITERRANEA LA NAVIERA DE FORMENTERA S.L.', 'B16620635', 'Ctra. Sant Francesc - La savina');
...
INSERT INTO `trabajadores` (`id_trabajador`, `codigo_tr`, `dni_tr`, `nombre_tr`, `fechanac_tr`, `categoria_tr`, `inicio_tr`, `centro_tr`, `activo_tr`, `anotaciones_tr`, `fyh_creacion`, `fyh_actualizacion`) VALUES
(3, 110, '47627004F', 'VIVES GARCIA, EMILI', '1979-10-03', 1, '2021-08-01', 4, 1, '', '2023-11-17 09:56:23', '2023-11-17 09:56:23'),
(4, 221, '12452145F', 'SANCHEZ TORRES, JOSE LUIS', '1988-11-01', 2, '2023-07-11', 7, 0, '', '2023-11-17 09:56:23', '2023-11-17 09:56:23'),
(5, 98898, '00001000T', 'PEREZ PEREZ, PRUEBA', '1988-11-09', 2, '2023-10-31', 4, 1, '', '2023-11-27 08:32:45', '2023-11-27 08:32:45'),
(6, 125855, '11244484F', 'RUIZ RUIZ, PEPE', '2023-11-14', 2, '2023-11-07', 6, 1, '', '2023-11-27 08:34:16', '2023-11-27 08:34:16'),
(7, 1254, '125444587S', 'SANCHEZ PERA, JOSE LUIS', '1988-06-11', 2, '2021-08-12', 7, 1, '', '2023-12-07 12:25:18', '2023-12-07 12:25:18'),
(8, 1009, '56855222L', 'LUENGO ROJAS, JAVIER', '2008-02-12', 21, '2023-12-14', 4, 1, '', '2023-12-12 14:18:59', '2023-12-12 14:18:59'),
(9, 1885, '65532455R', 'FERNANDEZPEREZ, JOSE', '1979-12-15', 2, '2023-12-01', 5, 1, '', '2023-12-13 11:47:07', '2023-12-13 11:47:07'),
(10, 2556, '45875454S', 'GARCIA GARCIA, MANUEL', '1988-12-05', 2, '2023-12-15', 7, 1, '', '2023-12-13 11:48:08', '2023-12-13 11:48:08');
...
ALTER TABLE `formacion`
  ...
  ADD KEY `FK_formador_fr` (`formador_fr`) USING BTREE,
...
--
ALTER TABLE `formacion`
  MODIFY `id_formacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
ALTER TABLE `formacion`
  ...
  ADD CONSTRAINT `formacion_ibfk_3` FOREIGN KEY (`formador_fr`) REFERENCES `responsables` (`id_responsable`) ON DELETE NO ACTION ON UPDATE CASCADE,
